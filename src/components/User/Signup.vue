      ...
      <v-card class="elevation-12">
        ...
        <v-form @submit.prevent="onSingUp">
          <v-card-text>
            ...
            <v-text-field id="confirmPassword" label="Подтвердите пароль" name="confirmPassword" prepend-icon="lock" type="password" v-model="confirmPassword" :rules="[comparePasswords]"></v-text-field>
          </v-card-text>
          <v-card-actions>
            <v-spacer></v-spacer>
